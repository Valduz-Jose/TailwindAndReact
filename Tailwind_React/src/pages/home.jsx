...
export const Home = () =>{
    ...
    return(
        <main className="bg-primary h-screen dark:bg-primary-drak flex flex-col items-center justify-center overflow-hidden">
            ...
            <button className="p-2 rounded-lg bg-white dark:bg-black text-black dark:text-white font-semibold" onClick={toggleTheme}>{theme === "light" ? "🌞 Modo claro":"🌚 Modo Oscuro"}</button>
        </main>
    );
};